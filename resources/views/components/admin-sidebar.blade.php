        ...
        <li class="nav-item dropdown has-arrow main-drop">
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <hr class="m-0">
                    <a class="pb-0 dropdown-item logout" href="signin.html"><img src="/assets/img/icons/log-out.svg"
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="{{ Request::routeIs('category*') ? 'active' : '' }}">
                    <a href="{{ route('category.index') }}"><img src="/assets/img/icons/product.svg" alt="img"><span>
                            Category</span> </a>
                </li>
